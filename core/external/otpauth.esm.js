...
class f {
    ...
    M(t) {
        ...
        for (
            n < t.binLen / 8 && (t.value = this.F(t.value, t.binLen, 0, this.B(this.s), this.U));
            t.value.length <= e;
...
function v(t, n, e, r) {
    ...
    for (
        t[n >>> 5] |= 128 << (24 - (n % 32)), t[s] = 4294967295 & o, t[s - 1] = (o / 4294967296) | 0, i = 0;
        i < t.length;
        i += 16
    )
    ...
    for (e = n[0], r = n[1], i = n[2], s = n[3], o = n[4], h = n[5], u = n[6], w = n[7], a = 0; a < 80; a += 1)
        a < 16
            ...
            (c = z(
                w,
                P(o),
                ((H = h), (S = u), new B(((E = o).Y & H.Y) ^ (~E.Y & S.Y), (E.N & H.N) ^ (~E.N & S.N))),
                V[a],
                A[a]
            )),
            (f = I(N(e), Y(e, r, i))),
    ...
    for (e = 0; e < 24; e += 1) {
        ...
        for (r = 0; r < 5; r += 1)
            for (i = 0; i < 5; i += 1)
                n[r][i] = x(
                    s[r][i],
                    new B(~s[(r + 1) % 5][i].Y & s[(r + 2) % 5][i].Y, ~s[(r + 1) % 5][i].N & s[(r + 2) % 5][i].N)
                )
    ...
    constructor(t, n, r) {
        ...
        ;(this.F = function (t, n, e, r, o) {
            return (function (t, n, e, r, i, s, o) {
                ...
                for (
                    h = n >>> 3, t[h >> 2] ^= s << ((h % 4) * 8), t[f - 1] ^= 2147483648, r = W(t, r);
                    32 * c.length < o && ((u = r[w % 5][(w / 5) | 0]), c.push(u.N), !(32 * c.length >= o));
