      ...
      return function (t) {
        return (function (t, n, e, r) {
          ...
          for (i = 0; i < h; i += 1)
            (s = t[i >>> 2] >>> (8 * (u + e * (i % 4)))),
              (o +=
                '0123456789abcdef'.charAt((s >>> 4) & 15) +
                '0123456789abcdef'.charAt(15 & s))
...
function u(t, n) {
  ...
  if (i % 4 != 0) {
    ...
    return (
      (t.value.length << 2) - 4 >= s + i && t.value.pop(),
      {
        value: t.value,
...
class f {
  ...
  update(t) {
    ...
    for (n = 0; n < h; n += r)
      e + this.p <= s &&
        ((this.C = this.R(o.slice(n, n + r), this.C)), (e += this.p))
  ...
  getHash(t, n) {
    ...
    for (
      i = this.F(this.o.slice(), this.h, this.l, this.g(this.C), s), e = 1;
      e < this.numRounds;
      e += 1
    )
      this.v &&
  ...
  M(t) {
    ...
    for (
      n < t.binLen / 8 &&
      (t.value = this.F(t.value, t.binLen, 0, this.B(this.s), this.U));
      t.value.length <= e;
    ...
    for (r = 0; r <= e; r += 1)
      (this.H[r] = 909522486 ^ t.value[r]),
        (this.S[r] = 1549556828 ^ t.value[r])
  ...
  k() {
    ...
    return (
      (t = this.R(this.S, this.B(this.s))),
      (t = this.F(n, this.U, this.p, t, this.U)),
      t
    )
  }
}
    ...
    ;(this.T = this.k),
      ...
      (this.F = function (n, e, r, i) {
        return (function (t, n, e, r, i) {
          ...
          return (
            (o =
              'SHA-224' === i ? [r[0], r[1], r[2], r[3], r[4], r[5], r[6]] : r),
            o
          )
        })(n, e, r, i, t)
      }),
...
function Y(t, n, e) {
  return new B(
    (t.Y & n.Y) ^ (t.Y & e.Y) ^ (n.Y & e.Y),
    (t.N & n.N) ^ (t.N & e.N) ^ (n.N & e.N)
  )
}
...
function I(t, n) {
  let e, r
  ;(e = (65535 & t.N) + (65535 & n.N)),
    (r = (t.N >>> 16) + (n.N >>> 16) + (e >>> 16))
  const i = ((65535 & r) << 16) | (65535 & e)
  ;(e = (65535 & t.Y) + (65535 & n.Y) + (r >>> 16)),
    (r = (t.Y >>> 16) + (n.Y >>> 16) + (e >>> 16))
...
function X(t, n, e, r) {
  ...
  ;(i =
    (65535 & t.Y) + (65535 & n.Y) + (65535 & e.Y) + (65535 & r.Y) + (s >>> 16)),
  ...
  for (
    ...
    a < 16
      ...
      (c = z(
        ...
        ((H = h),
        (S = u),
        new B(((E = o).Y & H.Y) ^ (~E.Y & S.Y), (E.N & H.N) ^ (~E.N & S.N))),
        V[a],
        A[a]
      )),
      (f = I(N(e), Y(e, r, i))),
...
function W(t, n) {
  ...
  for (e = 0; e < 24; e += 1) {
    ...
    for (r = 0; r < 5; r += 1)
      for (i = 0; i < 5; i += 1) n[r][i] = x(n[r][i], h[r])

    for (r = 0; r < 5; r += 1)
      for (i = 0; i < 5; i += 1) s[i][(2 * r + 3 * i) % 5] = L(n[r][i], G[r][i])
    ...
    for (r = 0; r < 5; r += 1)
      for (i = 0; i < 5; i += 1)
        n[r][i] = x(
          s[r][i],
          new B(
            ~s[(r + 1) % 5][i].Y & s[(r + 2) % 5][i].Y,
            ~s[(r + 1) % 5][i].N & s[(r + 2) % 5][i].N
          )
        )
...
class et extends f {
      ...
      return (function (t, n, e, r, i, s, o) {
        ...
        for (
          h = n >>> 3,
            ...
            r = W(t, r);
          32 * c.length < o &&
          ((u = r[w % 5][(w / 5) | 0]), c.push(u.N), !(32 * c.length >= o));
  ...
  _(t, n) {
    ...
    if (0 !== e.customization.binLen || 0 !== e.funcName.binLen) {
      ...
      for (let n = 0; n < t.length; n += this.p >>> 5)
        (this.C = this.R(t.slice(n, n + (this.p >>> 5)), this.C)),
          (this.l += this.p)
  ...
  I(t) {
    ...
    for (let t = 0; t < e.length; t += this.p >>> 5)
      (this.C = this.R(e.slice(t, t + (this.p >>> 5)), this.C)),
        (this.l += this.p)
...
class jsSHA {
  constructor(t, n, e) {
    if ('SHA-1' == t) this.O = new K(t, n, e)
    else if ('SHA-224' == t || 'SHA-256' == t) this.O = new g(t, n, e)
    else if ('SHA-384' == t || 'SHA-512' == t) this.O = new q(t, n, e)
    else {
      if (
        'SHA3-224' != t &&
        'SHA3-256' != t &&
...
const hmacDigest = (algorithm, key, message) => {
  if (isNode) {
    const hmac = NodeCrypto$2.createHmac(
      algorithm,
      globalScope.Buffer.from(key)
    )
